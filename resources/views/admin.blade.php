...
<div class="container">
    ...
    @endforeach
    <div class="col">
        <a href="{{url('/admin/orders/')}}" class=" btn btn-primary">Заказы</a>
    </div>
    
</div>

<iframe width="1905" height="792" src="https://www.youtube.com/embed/kCbxQpn4Yzo" title="Винтаж - Плохая девочка" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
